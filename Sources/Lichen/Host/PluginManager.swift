...
//  Lichen
//
//  Lichen-owned override of AppexSaverMinimal's PluginManager: only the identity
//  strings change (bundle identifier, screensaver module/display name, embedded
//  appex filename). All pluginkit + PaperSaverKit logic is unchanged.
//
...
class PluginManager: ObservableObject {
    ...
    private let bundleIdentifier = "com.janbridley.lichen.Extension"
    ...
    private let screensaverDisplayName = "LichenExtension"
    ...
    ///   `+    com.janbridley.lichen.Extension(1.0) <path>`
