...
//  Lichen
//
//  Lichen-owned override of AppexSaverMinimal's ContentView: only the header
//  identity (icon + title) changes; all status/install/activation logic is
//  unchanged and driven by PluginManager.
//
